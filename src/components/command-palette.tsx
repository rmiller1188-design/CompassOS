          ...
          <section className={styles.palette} role="dialog" aria-modal="true" aria-label="Compass command center">
            ...
            <div className={styles.body}>
              ...
              <div className={styles.grid}>
                ...
                {!filtered.length && <button className={styles.item} type="submit" form="compass-command-search"><span className={styles.itemIcon}>⌕</span><span><b>Search Compass for “{query.trim()}”</b><small>Messages, calendar, projects, people, files, tasks, and decisions</small></span><span className={styles.arrow}>↵</span></button>}
              </div>
            </div>
